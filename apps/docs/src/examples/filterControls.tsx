...
export function AccountFilter({
  ...
  return (
    <form className="docsExample-filter" aria-label="Account filter">
      <label>
        Search account
        <input
      ...
      <div className="docsExample-filterFooter">
...
export function ActivityFilter({
  ...
  return (
    <form className="docsExample-filter" aria-label="Activity filter">
      <label>
        Last activity after
        <input
          type="date"
